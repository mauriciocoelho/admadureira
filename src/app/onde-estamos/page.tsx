...
const OndeEstamos = () => {
    ...
    const imgIgreja = '/img/congregacao/igreja-tds.png';
    ...
    const locations = [
        ...
        { name: 'Amor em Cristo', imgSrc: imgIgreja },
        { name: 'Betel', imgSrc: imgIgreja },
        ...
        { name: 'El Shaday', imgSrc: imgIgreja },
        ...
        { name: 'Familia Feliz', imgSrc: imgIgreja },
        ...
        { name: 'Jardim América', imgSrc: imgIgreja, link: 'https://www.google.com/maps/@-10.6964346,-48.3979808,3a,75y,340.74h,76.35t/data=!3m6!1e1!3m4!1scLEodbxyETierUmbMj4KiA!2e0!7i13312!8i6656?coh=205409&entry=ttu' },
        ...
        { name: 'Shekinah', imgSrc: imgIgreja },
        { name: 'Manancial', imgSrc: '/img/congregacao/manancial.png' },        
        ...
        { name: 'Monte Moriá', imgSrc: imgIgreja },
        { name: 'Monte Sião', imgSrc: imgIgreja },
